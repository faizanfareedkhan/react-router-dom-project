            ...
            <ul className="mt-4 flex flex-col font-medium lg:mt-0 lg:flex-row lg:space-x-8">
              <li>
                <NavLink
                  to={"/"}
                  className={({ isActive }) =>
                    `block border-b border-gray-100 py-2 pl-3 pr-4 duration-200 hover:bg-gray-50 hover:text-orange-700 lg:border-0 lg:p-0 lg:hover:bg-transparent ${isActive ? "text-orange-700" : "text-gray-700"}`
                  }
                >
                  Home
                </NavLink>
